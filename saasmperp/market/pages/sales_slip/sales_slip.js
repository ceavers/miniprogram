...
Page({
  ...
  nextStep(){
    if(!this.data.customerId){
      ...
      wx.navigateTo({
        url: '/market/pages/create_new_order/create_new_order?orderMoney=' + this.data.totalMoney + '&images=' + JSON.stringify(this.data.imageList),
      })
    } else {
      wx.showToast({
  ...
  gotoSelectUser(){
    wx.navigateTo({
      url: '/market/pages/select_user/select_user?type=customer',
    })
  },
  //查看历史
  gotoHistory(){
