...
Page({
  ...
  onLoad: function (options) {
    this.setData({
      customerDetailMes: JSON.parse(options.userMes),
      touxiangSrc: [JSON.parse(options.userMes).user_image],
      customerTypeId: JSON.parse(options.userMes).user_type_id,
      customerType: JSON.parse(options.userMes).user_type
    })
